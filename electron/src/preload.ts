...
contextBridge.exposeInMainWorld("firstmate", {
  ...
  conversation: { create: (message: string, existingTask?: string) => ipcRenderer.invoke("conversation:create", message, existingTask) },
